...
ROTEIRO = [
    ...
    ("net-wifi-cliente", "Internet", "tomada", "Conectar o dongle no Wi-Fi de casa",
     "Com o dongle na tomada, conecte o dongle a uma rede Wi-Fi em Internet › Conectar a uma rede Wi-Fi. ANOTE o endereço que a tela mostrar ao conectar. Entre na mesma rede com o celular/PC e abra esse endereço (ou opendongle.local, ou ferramentas/opendongle_localizar.py).",
     "A tela informa o endereço recebido do roteador; o hotspot some, o LED fica azul e o painel abre nesse endereço pela rede de casa."),
    ("net-resgate-boot", "Internet", "tomada", "Resgate: religar devolve o hotspot",
     "Com o dongle conectado no Wi-Fi de casa, tire da tomada, espere 5 segundos e ligue de novo. Espere cerca de 1 minuto e procure a rede do dongle no celular.",
     "A rede Wi-Fi do dongle volta sozinha (todo boot começa no hotspot). No painel, em Conectar a uma rede Wi-Fi, o botão Reconectar devolve a rede de casa sem pedir a senha."),
